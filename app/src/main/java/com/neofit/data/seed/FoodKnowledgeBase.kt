...
object FoodKnowledgeBase {
    ...
    val foods: List<FoodItem> = listOf(
        ...
        // ---- SOUTH INDIA · restaurant / tiffin menu (researched estimates) ----
        item("rava_dosa", "Rava Dosa", SOUTH, VEGAN, BREAKFAST, piece, 260, 5f, 38f, 10f, 1f, ROASTED,
            ingredients = listOf("rava", "rice flour"), tags = listOf("tiffin"), aliases = listOf("rava dose", "onion rava dosa"),
            names = mapOf("ta" to "ரவா தோசை", "kn" to "ರವಾ ದೋಸೆ", "te" to "రవ్వ దోస")),
        item("onion_uttapam", "Onion Uttapam", SOUTH, VEGAN, BREAKFAST, piece, 300, 7f, 45f, 9f, 2f, ROASTED,
            ingredients = listOf("rice", "urad dal", "onion"), tags = listOf("tiffin"), aliases = listOf("uttapam", "uthappam"),
            names = mapOf("ta" to "உத்தப்பம்", "kn" to "ಉತ್ತಪ್ಪ")),
        item("set_dosa", "Set Dosa", SOUTH, VEGAN, BREAKFAST, p2, 320, 7f, 52f, 8f, 2f, ROASTED,
            ingredients = listOf("rice", "urad dal", "poha"), tags = listOf("tiffin"), aliases = listOf("sponge dosa"),
            names = mapOf("kn" to "ಸೆಟ್ ದೋಸೆ")),
        item("pesarattu", "Pesarattu", SOUTH, VEGAN, BREAKFAST, piece, 220, 11f, 30f, 6f, 4f, ROASTED,
            ingredients = listOf("green moong dal", "ginger"), tags = listOf("tiffin", "andhra"), aliases = listOf("moong dal dosa", "pesara attu"),
            names = mapOf("te" to "పెసరట్టు")),
        item("appam", "Appam", SOUTH, VEGAN, BREAKFAST, piece, 140, 3f, 26f, 3f, 1f, STEAMED,
            confidence = HIGH, ingredients = listOf("rice", "coconut"), tags = listOf("kerala"), aliases = listOf("palappam", "aappam"),
            names = mapOf("ml" to "അപ്പം", "ta" to "ஆப்பம்")),
        item("puttu", "Puttu", SOUTH, VEGAN, BREAKFAST, PortionSize("1 piece", 1f, 150), 240, 5f, 45f, 4f, 4f, STEAMED,
            ingredients = listOf("rice flour", "coconut"), tags = listOf("kerala"),
            names = mapOf("ml" to "പുട്ട്")),
        item("idiyappam", "Idiyappam", SOUTH, VEGAN, BREAKFAST, PortionSize("3 pieces", 1f), 200, 4f, 44f, 1f, 1f, STEAMED,
            ingredients = listOf("rice flour"), tags = listOf("kerala"), aliases = listOf("string hoppers", "nool puttu", "sevai"),
            names = mapOf("ml" to "ഇടിയപ്പം", "ta" to "இடியாப்பம்")),
        item("poori_masala", "Poori Masala", SOUTH, VEGAN, BREAKFAST, plate, 420, 9f, 58f, 16f, 4f, FRIED,
            ingredients = listOf("wheat", "potato"), tags = listOf("tiffin"), aliases = listOf("poori", "puri masala", "poori bhaji"),
            names = mapOf("hi" to "पूरी मसाला")),
        item("rava_idli", "Rava Idli", SOUTH, VEG, BREAKFAST, p2, 220, 6f, 36f, 5f, 2f, STEAMED,
            ingredients = listOf("rava", "curd"), tags = listOf("tiffin"),
            names = mapOf("kn" to "ರವಾ ಇಡ್ಲಿ")),
        item("kesari_bath", "Kesari Bath", SOUTH, VEG, BREAKFAST, katori, 280, 4f, 45f, 10f, 1f, ROASTED,
            sweet = true, ingredients = listOf("rava", "sugar", "ghee"), tags = listOf("tiffin", "sweet"), aliases = listOf("rava kesari", "kesari", "sheera"),
            names = mapOf("kn" to "ಕೇಸರಿ ಬಾತ್")),
        item("khara_bath", "Khara Bath", SOUTH, VEG, BREAKFAST, katori, 260, 6f, 40f, 9f, 2f, ROASTED,
            ingredients = listOf("rava", "vegetables", "ghee"), tags = listOf("tiffin"), aliases = listOf("kharabath", "masala upma"),
            names = mapOf("kn" to "ಖಾರಾ ಬಾತ್")),
        item("bisi_bele_bath", "Bisi Bele Bath", SOUTH, VEG, LUNCH, PortionSize.BOWL, 360, 10f, 55f, 11f, 5f, BOILED,
            ingredients = listOf("rice", "toor dal", "vegetables", "ghee"), tags = listOf("karnataka"), aliases = listOf("bisibelebath", "bisi bele huliyanna"),
            names = mapOf("kn" to "ಬಿಸಿ ಬೇಳೆ ಬಾತ್")),
        item("lemon_rice", "Lemon Rice", SOUTH, VEGAN, LUNCH, katori, 300, 5f, 48f, 9f, 2f, ROASTED,
            ingredients = listOf("rice", "lemon", "peanuts"), aliases = listOf("chitranna", "nimmakaya pulihora"),
            names = mapOf("kn" to "ಚಿತ್ರಾನ್ನ", "ta" to "எலுமிச்சை சாதம்")),
        item("tamarind_rice", "Tamarind Rice", SOUTH, VEGAN, LUNCH, katori, 320, 5f, 52f, 10f, 3f, ROASTED,
            ingredients = listOf("rice", "tamarind", "peanuts"), aliases = listOf("puliyogare", "pulihora", "puliyodarai"),
            names = mapOf("te" to "పులిహోర", "ta" to "புளியோதரை", "kn" to "ಪುಲಿಯೋಗರೆ")),
        item("coconut_rice", "Coconut Rice", SOUTH, VEGAN, LUNCH, katori, 320, 5f, 45f, 13f, 3f, ROASTED,
            ingredients = listOf("rice", "coconut"), aliases = listOf("thengai sadam", "kobbari annam"),
            names = mapOf("ta" to "தேங்காய் சாதம்")),
        item("rasam", "Rasam", SOUTH, VEGAN, LUNCH, katori, 60, 2f, 9f, 2f, 1f, CURRY,
            confidence = HIGH, ingredients = listOf("tamarind", "tomato", "pepper"), aliases = listOf("saaru", "chaaru", "charu"),
            names = mapOf("ta" to "ரசம்", "te" to "చారు", "kn" to "ಸಾರು")),
        item("rasam_rice", "Rasam Rice", SOUTH, VEGAN, LUNCH, PortionSize.BOWL, 230, 6f, 42f, 4f, 2f, BOILED,
            ingredients = listOf("rice", "rasam"), aliases = listOf("rasam sadam"),
            names = mapOf("ta" to "ரசம் சாதம்")),
        item("veg_kurma", "Vegetable Kurma", SOUTH, VEGAN, LUNCH, katori, 200, 5f, 18f, 12f, 4f, CURRY,
            ingredients = listOf("mixed vegetables", "coconut", "cashew"), aliases = listOf("korma", "saagu", "kurma")),
        item("avial", "Avial", SOUTH, VEG, LUNCH, katori, 160, 4f, 12f, 11f, 4f, CURRY,
            ingredients = listOf("mixed vegetables", "coconut", "curd"), tags = listOf("kerala"),
            names = mapOf("ml" to "അവിയൽ", "ta" to "அவியல்")),
        item("poriyal", "Poriyal", SOUTH, VEGAN, LUNCH, katori, 120, 4f, 12f, 7f, 4f, ROASTED,
            ingredients = listOf("vegetables", "coconut"), aliases = listOf("thoran", "palya", "stir fry"),
            names = mapOf("ta" to "பொரியல்")),
        item("coconut_chutney", "Coconut Chutney", SOUTH, VEGAN, BREAKFAST, PortionSize("2 tbsp", 1f, 40), 90, 1f, 4f, 8f, 1f, RAW,
            ingredients = listOf("coconut", "green chilli"), tags = listOf("side"), aliases = listOf("thengai chutney", "chutney"),
            names = mapOf("ta" to "தேங்காய் சட்னி")),
        item("south_thali", "South Indian Meals", SOUTH, VEG, LUNCH, plate, 650, 18f, 100f, 20f, 12f, CURRY,
            confidence = ROUGH, ingredients = listOf("rice", "sambar", "rasam", "curd", "vegetables"), tags = listOf("combo"),
            aliases = listOf("meals", "south indian thali", "full meals")),
        item("mysore_bonda", "Mysore Bonda", SOUTH, VEG, SNACK, p2, 230, 5f, 28f, 11f, 1f, FRIED,
            street = true, confidence = ROUGH, ingredients = listOf("urad dal", "maida"), tags = listOf("tiffin"), aliases = listOf("bonda", "ulundu bonda"),
            names = mapOf("kn" to "ಮೈಸೂರು ಬೋಂಡಾ")),
        item("bajji", "Bajji", SOUTH, VEGAN, SNACK, PortionSize("3 pieces", 1f), 240, 5f, 28f, 12f, 2f, FRIED,
            street = true, confidence = ROUGH, ingredients = listOf("besan", "vegetables"), aliases = listOf("bonda", "mirchi bajji", "molaga bajji"),
            names = mapOf("ta" to "பஜ்ஜி", "kn" to "ಬಜ್ಜಿ")),
        item("maddur_vada", "Maddur Vada", SOUTH, VEGAN, SNACK, piece, 110, 2f, 14f, 6f, 1f, FRIED,
            street = true, confidence = ROUGH, ingredients = listOf("rava", "rice flour", "onion"), tags = listOf("karnataka"),
            names = mapOf("kn" to "ಮದ್ದೂರು ವಡೆ")),
        item("sambar_vada", "Sambar Vada", SOUTH, VEG, SNACK, piece, 200, 6f, 26f, 8f, 2f, FRIED,
            confidence = ROUGH, ingredients = listOf("urad dal", "sambar"), tags = listOf("tiffin"), aliases = listOf("sambar vadai", "thayir vadai"),
            names = mapOf("ta" to "சாம்பார் வடை")),
        item("mangalore_bun", "Mangalore Buns", SOUTH, VEG, SNACK, p2, 280, 5f, 44f, 9f, 2f, FRIED,
            street = true, confidence = ROUGH, ingredients = listOf("maida", "banana", "curd"), tags = listOf("karnataka"), aliases = listOf("banana buns", "mangalore bun"),
            names = mapOf("kn" to "ಮಂಗಳೂರು ಬನ್ಸ್")),
        item("kerala_parotta", "Kerala Parotta", SOUTH, VEGAN, DINNER, piece, 280, 6f, 42f, 10f, 2f, FRIED,
            ingredients = listOf("maida", "oil"), tags = listOf("kerala"), aliases = listOf("malabar parotta", "parotta", "barotta"),
            names = mapOf("ml" to "പൊറോട്ട", "ta" to "பரோட்டா")),
        item("chicken_65", "Chicken 65", SOUTH, NONVEG, SNACK, PortionSize("100 g", 1f, 100), 320, 22f, 12f, 20f, 1f, FRIED,
            ingredients = listOf("chicken", "spices", "curry leaves"), tags = listOf("starter"),
            names = mapOf("ta" to "சிக்கன் 65")),
        item("chicken_chettinad", "Chicken Chettinad", SOUTH, NONVEG, DINNER, katori, 290, 24f, 8f, 18f, 2f, CURRY,
            ingredients = listOf("chicken", "coconut", "chettinad spices"), tags = listOf("tamil nadu"), aliases = listOf("chettinad chicken"),
            names = mapOf("ta" to "செட்டிநாடு கோழி")),
        item("chettinad_mutton", "Chettinad Mutton", SOUTH, NONVEG, DINNER, katori, 360, 24f, 8f, 26f, 2f, CURRY,
            ingredients = listOf("mutton", "coconut", "chettinad spices"), tags = listOf("tamil nadu"), aliases = listOf("mutton chettinad", "chettinad mutton curry")),
        item("fish_fry_south", "South Indian Fish Fry", SOUTH, NONVEG, LUNCH, piece, 250, 22f, 6f, 15f, 0f, FRIED,
            ingredients = listOf("fish", "spices", "rice flour"), tags = listOf("coastal"), aliases = listOf("meen varuval", "fish fry")),
        item("prawn_curry_south", "Prawn Curry (South)", SOUTH, NONVEG, LUNCH, katori, 220, 20f, 8f, 12f, 1f, CURRY,
            ingredients = listOf("prawns", "coconut"), tags = listOf("coastal"), aliases = listOf("chemmeen curry", "eral", "prawn masala"),
            names = mapOf("ml" to "ചെമ്മീൻ കറി")),
        item("egg_roast_kerala", "Egg Roast (Kerala)", SOUTH, EGG, BREAKFAST, katori, 240, 12f, 10f, 16f, 2f, CURRY,
            ingredients = listOf("egg", "onion", "coconut oil"), tags = listOf("kerala"), aliases = listOf("mutta roast", "egg roast"),
            names = mapOf("ml" to "മുട്ട റോസ്റ്റ്")),
        item("mysore_pak", "Mysore Pak", SOUTH, VEG, SNACK, PortionSize("1 piece", 1f, 30), 200, 2f, 22f, 12f, 0f, FRIED,
            sweet = true, ingredients = listOf("besan", "ghee", "sugar"), tags = listOf("sweet", "karnataka"),
            names = mapOf("kn" to "ಮೈಸೂರು ಪಾಕ್")),
        item("payasam", "Payasam", SOUTH, VEG, SNACK, katori, 200, 5f, 32f, 6f, 0f, BOILED,
            sweet = true, ingredients = listOf("vermicelli", "milk", "sugar"), tags = listOf("sweet"), aliases = listOf("kheer", "payasa", "semiya payasam"),
            names = mapOf("ml" to "പായസം", "ta" to "பாயசம்", "kn" to "ಪಾಯಸ", "te" to "పాయసం")),
        item("badam_milk", "Badam Milk", SOUTH, VEG, SNACK, glass, 180, 7f, 22f, 8f, 1f, RAW,
            sweet = true, ingredients = listOf("milk", "almond", "saffron"), tags = listOf("beverage"), aliases = listOf("almond milk", "badam haal")),
